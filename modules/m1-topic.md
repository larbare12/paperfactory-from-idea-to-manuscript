...
- ARS: [Socratic 提问框架](../reference/ars/deep-research/socratic_questioning_framework.md) — idea 澄清与收敛
- ARS: [跨学科桥梁](../reference/ars/deep-research/interdisciplinary_bridges.md) — 交叉领域创新性评估
- ARS: [伦理检查清单](../reference/ars/deep-research/ethics_checklist.md) — 早期伦理风险筛查
- ARS: [各领域顶级期刊](../reference/ars/reviewer/top_journals_by_field.md) — 投稿目标选择参考
- ARS: [文献来源质量层级](../reference/ars/deep-research/source_quality_hierarchy.md) — 文献质量评估框架
