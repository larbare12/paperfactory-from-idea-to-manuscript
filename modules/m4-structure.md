...
### Step 2: 选定骨架
按下方模板生成章节列表。**参照 [论文结构模式](../reference/writing/paper_structure_patterns.md) 根据论文特征从 6 种结构模型中选择**——IMRaD（方法/实证型）、主题文献综述、理论分析、案例研究、政策简报、会议论文——每种模型有完整的章节大纲和篇幅配比参考。
...
- ARS: [论文结构模式](../reference/writing/paper_structure_patterns.md) — IMRaD 变体与替代结构
